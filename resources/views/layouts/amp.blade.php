...
@stack('meta')
    ...
    {{-- <link rel="stylesheet" href="{{ asset('/css/amp-home.css') }}"> --}}
    ...
    <style amp-custom="">
@import url('https://fonts.googleapis.com/css?family=Dosis:400,700|Open+Sans:400,400i,700,700i');
body {
    font-size: 18px;
...
<body>
    ...
    <header class="ampstart-headerbar fixed flex justify-start items-center top-0 left-0 right-0 pl2 pr4 ">
        ...
        <amp-img src="{{ asset('/icons/android-icon-144x144.png') }}" width="100" height="61.3" layout="fixed" class="my0 mx-auto " alt="The Blog"></amp-img>
    </header>
