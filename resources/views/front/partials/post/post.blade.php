            ...
            <section class="detail-info">
                <div class="card">
                    <div class="card-body">
                        ...
                        <br> {!! Markdown::parse($post->content) !!}
                        <br>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-xs-12">
                                <div class="articles-author">
                                    <img src="https://secure.gravatar.com/avatar/b5a93f6390e4bdb85a484d15b549d467?s=75&d=mm&r=g"
                                        class="rounded-circle" alt="" data-rjs="2">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="banner-wrapper">
                                        ...
                                        <img class="img-fluid" src="{{ asset('/img/cat/laravel.jpg') }}" alt="Laravel Logo"
                                            data-rjs="2">
                                    </div>
                                </div>
